...
class DebugWindow(AppBaseState):
    def __init__(self, app):
        ...
        self.ui_context.add_widget(SingleLineText((100, 200), (300, 50), "editable", self.app, text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu.", font=self.app_state.title1f, background_color=(255, 0, 255), size_auto_fit=True, can_be_selected=True, editable=True))
